...
(async () => {
  ...
  const tests = [
    ...
    { sequence: ['5', '0', '0', '*', '5', '0', '%', 'bksp', '='], expectedResult: '250' },
    ...
    { sequence: ['6', '4', 'sqrt', '='], expectedResult: '8' },
    { sequence: ['1', '0', '0', '/', '2', '0', '%', '='], expectedResult: '50' },
    { sequence: ['1', '0', '0', '*', '5', '0', '+', '5', '0', '='], expectedResult: '5000' },
    { sequence: ['2', '0', '0', '/', '1', '0', '-', '5', '=', 'CE', '2', '0', '='], expectedResult: '20' },
    { sequence: ['3', '0', '0', '+', '1', '0', '0', '*', '2', '0', '0', '='], expectedResult: '20300' },
    { sequence: ['9', '9', '9', '*', '0', '.', '0', '1', '+', '0', '.', '0', '1', '='], expectedResult: '10.00' },
    { sequence: ['1', '0', '0', '+', '2', '0', '0', '*', '3', '0', '0', '='], expectedResult: '60100' },
    { sequence: ['2', '0', '0', '-', '1', '0', '0', '/', '5', '0', '='], expectedResult: '198' },
    { sequence: ['3', '0', '0', '*', '4', '0', '0', '+', '5', '0', '0', '='], expectedResult: '125000' },
    { sequence: ['9', '9', '9', '+', '1', '0', '0', '*', '0', '.', '0', '1', '='], expectedResult: '1099.90' },
  ];
