...
(async () => {
  ...
  const tests = [
    ...
    { sequence: ['1', '2', '3', '+', '4', '5', '6', 'bksp', '='], expectedResult: '168' },
    { sequence: ['2', '5', '.', '5', '*', '2', '='], expectedResult: '51' },
    { sequence: ['1', '4', '4', 'sqrt', '='], expectedResult: '12' },
    ...
    { sequence: ['9', 'sqrt', '=', '3'], expectedResult: '3' },
    { sequence: ['5', '0', '0', '*', '5', '0', '%', 'bksp', '='], expectedResult: '12500' },
    ...
    { sequence: ['1', '0', '0', '/', '2', '0', '%', '='], expectedResult: '50' },
    { sequence: ['1', '2', '3', '+', '4', '5', '6', 'bksp', '='], expectedResult: '178' },
    { sequence: ['2', '5', '.', '5', '*', '2', '='], expectedResult: '51.0' },
    { sequence: ['1', '4', '4', 'sqrt', '='], expectedResult: '12' },
    { sequence: ['2', '0', '0', '+', '1', '5', '0', 'CE', '2', '5', '='], expectedResult: '225' },
    { sequence: ['1', '2', '3', '4', '.', '5', '6', 'bksp', 'bksp', '='], expectedResult: '1234' },
    { sequence: ['1', '0', '0', '0', '*', '5', '0', '%', '='], expectedResult: '500' },
    ...
    { sequence: ['1', '0', '0', '*', '5', '0', '+', '5', '0', '='], expectedResult: '5050' },

    { sequence: ['2', '0', '0', '/', '1', '0', '-', '5', '=', 'CE', '2', '0', '='], expectedResult: '20' },

    { sequence: ['3', '0', '0', '+', '1', '0', '0', '*', '2', '0', '0', '='], expectedResult: '80000' },
    { sequence: ['9', '9', '9', '*', '0', '.', '0', '1', '+', '0', '.', '0', '1', '='], expectedResult: '10.00' },
    { sequence: ['1', '0', '0', '+', '2', '0', '0', '*', '3', '0', '0', '='], expectedResult: '90000' },
    { sequence: ['2', '0', '0', '-', '1', '0', '0', '/', '5', '0', '='], expectedResult: '2' },
    { sequence: ['3', '0', '0', '*', '4', '0', '0', '+', '5', '0', '0', '='], expectedResult: '120500' },
    { sequence: ['9', '9', '9', '+', '1', '0', '0', '*', '0', '.', '0', '1', '='], expectedResult: '10.99' },
  ];
